...
class BooleanAtomic(Atomic): #can be TRUE, FALSE or ( exprO ) or relationalExpr
    def __init__(self, type=AtomicEnum.BooleanAtomic, boolExpr= None, missing=None, relExpr=None, truthVal=None, notExpr=None):
    ...
    def toString(self):
        ...
        if self.notExpr != None:
            ...
            elif self.missing != None:
                return expr + self.missing.toString()
            else:
                return ""
