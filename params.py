...
# ICU TESTER Dataset
# variables = {'Pulse': [0.0, 400.0],  'hr': [30.0, 300.0], 'Mort': [0.0, 1.0], 'n_evts': [0.0, 5.0], 'tte': [-60, 100], 'death': [0.0, 1.0],'timeBound':[0.0, 1.0]}

# variables = {'LOS': [0.0, 122.0], 'Mort': [0.0, 1.0], 'n_evts': [0.0, 5.0],
#              'y': [0.0, 1.0], 'tte': [-60, 100], 'death': [0.0, 1.0],
#              'Pulse': [0.0, 400.0], 'BLOOD_UREA_NITROGEN': [1, 120], 'CREATININE': [0, 10.0], 'hr': [30.0, 300.0], 'timeBound':[0.0, 1.0]}
