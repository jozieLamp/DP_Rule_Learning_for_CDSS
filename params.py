...
cutoffThresh = 0.0001 #0.01 #V, Match score cutoff threshold to prune branches- was 0.001
...
maxQueries = 2000 #1000 #Maximum number of server queries allowed (to define for nonprivate + baseline model)
