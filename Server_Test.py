...
from MCTS.MCTS_Test import MCTS
...
class Server :
    ...
    def runProtocol(self, branchName, method, utcWeighting):
        ...
        mcts = MCTS(server=self, verbose=self.verbose, method=method, utcWeighting=utcWeighting)
